...
# Observa el código en el editor - solo lee un número de año y debe
# completarse con las instrucciones que implementan la prueba que acabamos de describir.
#
...
# lo contrario: No dentro del período del calendario Gregoriano. Consejo: utiliza los operadores != y %.
#
